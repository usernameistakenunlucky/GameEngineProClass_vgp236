...
public class ControllerScript : MonoBehaviour
{
    ...
    private GameObject _currentDropItem = null;
    ...
    void Update()
    {
        ...
        {
            if (_currentDropItem == null && GameManager.Instance.GetBallsRemaining() > 0 && GameManager.Instance.GetPlayerHp() > 0)
            {
                ...
                _currentDropItem = Instantiate(_dropItemPrefab, transform.position, rotationQuat);
                Debug.Log("New Item Spawned" + _currentDropItem.name);
            ...
            {
                Debug.Log("Can't spawn ball, ball is still in play!");
            }
